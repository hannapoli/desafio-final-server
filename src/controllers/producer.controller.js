const { getAllParcelsModel, getParcelByIDModel, getAllReportsModel, getReportByIDModel, deleteReportsByIDModel, createReportModel, updateReportModel, existsParcelModel, createParcelModel, deleteParcelModel, getInfoParcelSkyModel, getInfoParcelCropModel, getInfoParcelSoilModel } = require("../models/producer.model");
const { normalizeAttachedArray, uploadFilesToCloudinary, extractPublicIds, deteleFilesCloudinaryHelper, uploadOneFileCloudinaryHelper } = require("../helpers/cloudinary.helpers");
